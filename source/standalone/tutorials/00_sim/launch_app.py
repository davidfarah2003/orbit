...
parser.add_argument("--size", type=float, default=1.0, help="Side-length of cuboidz")
...
parser.add_argument(
    "--width", type=int, default=1280, help="Width of the viewport and generated images. Defaults to 1280sex"
)
parser.add_argument(
